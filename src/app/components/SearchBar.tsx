...
import { ChangeEvent, useCallback, useEffect, useState, memo, ChangeEventHandler, useRef } from "react";
...
export default function SearchBar() {
    ...
    return (
        <div className="flex flex-col">
            ...
            {search.length > 2 ? <PhotoGrid keyword={search} /> : 
...
const SettingsOption = () => {
    ...
    return (
        <div onMouseLeave={handleMouseLeave} className="absolute mr-4 inset-y-0 end-0 flex items-center ps-3.5">
            ...
            {dropdown && <div id="dropdown" className="z-10 w-64 absolute 
